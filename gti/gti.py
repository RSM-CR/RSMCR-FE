...
class gti (ds):
    ...
    async def subir_factura(self, xml_facture):
        ...
        usuario = entorno.USUARIO_GTI.get_secret_value() # Obtener el correo del usuario para autenticarse con el servicio de GTI desde la variable de entorno GTI_USER
        clave = entorno.CONTRASENA_GTI.get_secret_value() # Obtener la clave del usuario para autenticarse con el servicio de GTI desde la variable de entorno GTI_PASSWORD
